...
var hexPremierSig = "0200000001070a1f7acd045d943190dcdcedb10ecead328dac358dd268cd44a117f18ba03e0100000000ffffffff0240420f00000000001976a914f1374ee278fef24cbb93ae5a8849419475b99e8088ac000000000000000017a914270e4ed667c243ac37ccc9f237faa81dace08b6d8700000000";
var address3Private = "JA2gL3SQKSUPNU5DMHrbqBn3ASp9P8KGgMfQH2Dpb7JLkCPQPgiF";
...
function signrawtransactionMultisig2(hexPremierSig,ut,address3Private ) {
    return new Promise((resolve, reject) => {
      bitcoin_rpc.init(localhost, port, username, password)
      bitcoin_rpc.call('signrawtransaction', [hexPremierSig,[ut],[address3Private.toString()]], function (err, res) {
        if (err) {
  ...
  signrawtransactionMultisig2(hexPremierSig,ut,address3Private ) ;  


  /* RESULTAT = 
   ************res == {"result":{"hex":"0200000001070a1f7acd045d943190dcdcedb10ecead328dac358dd268cd44a117f18ba03e0100000000ffffffff0240420f00000000001976a914f1374ee278fef24cbb93ae5a8849419475b99e8088ac000000000000000017a914270e4ed667c243ac37ccc9f237faa81dace08b6d8700000000",
   */