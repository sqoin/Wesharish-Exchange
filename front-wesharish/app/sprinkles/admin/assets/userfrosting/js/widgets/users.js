...
function updateUser(userName, fieldName, fieldValue) {
    ...
    var url = site.uri.public + '/userWallet/api/users/u/' + userName + '/' + fieldName;
    ...
    el.find('.js-user-roles').click(function(e) {
        ...
        $("body").on('renderSuccess.ufModal', function (data) {
            ...
            roleWidget.ufCollection({
                dropdown : {
                    ajax: {
                        url     : site.uri.public + '/userWallet/api/roles'
                    },
            ...
            $.getJSON(site.uri.public + '/userWallet/api/users/u/' + userName + '/roles')
            .done(function (data) {
