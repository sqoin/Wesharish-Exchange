...
class Transaction extends Model
{
    ...
    public function scopeJoinUser($query)
    {
        ...
        $query = $query->leftJoin('users', 'transactions.userfrom_id', '=', 'users.id');
...
/*    public function scopeMostRecentEvents($query)
  ...
  /*  public function scopeMostRecentEventsByType(Builder $query, $type)
    ...
    public function user1()
    {
        ...
        return $this->belongsTo($classMapper->getClassMapping('user'), 'userfrom_id');
    }
    public function user2()
    {
        ...
        return $this->belongsTo($classMapper->getClassMapping('user'), 'userto_id');
    }
