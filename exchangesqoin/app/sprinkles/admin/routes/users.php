...
$app->group('/userWallet/api/users', function () {
   ...
   $this->get('/current', 'UserFrosting\Sprinkle\Admin\Controller\UserController:getCurrent');
    ...
    $this->get('/u/{user_name}/transactions', 'UserFrosting\Sprinkle\Admin\Controller\UserController:getTransactions');
    $this->get('/u/{user_name}/order', 'UserFrosting\Sprinkle\Admin\Controller\UserController:getOrder');
