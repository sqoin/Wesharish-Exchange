  ...
  <div>
    ...
    <div class="card">
      ...
      <div class="card-body row table-full-width">
        <div class="col-sm-12">
          <el-table class="table-striped" header-row-class-name="text-primary" :data="tableData">
            <el-table-column type="index"></el-table-column>
            <el-table-column prop="name" label="Name"></el-table-column>
            <el-table-column prop="job" label="Job Position"></el-table-column>
            <el-table-column prop="salary" align="center" label="Salary"></el-table-column>
            <el-table-column align="right" label="Active">
              <template slot-scope="props">
        ...
        <div class="card">
          ...
          <div class="table-responsive">
            ...
            >
              ...
              <el-table-column class-name="td-number" min-width="80" class="td-price" label="Price">
                <template slot-scope="props">
                  <small>&euro;</small>
                  {{props.row.price}}
                </template>
                ...
                <template slot-scope="props">
                  ...
                  <div class="btn-group btn-group-sm">
                    <p-button
                      ...
                      outline
                      size="sm"
                      @click="props.row.quantity > 0 ? props.row.quantity-- : 0"
                    >
